        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="na\vbarNavAltMarkup">
                <div class="navbar-nav mx-left">
                    <a class="nav-link text-light" href="reza_HOME.PHP">Home</a>
                    <a class="nav-link text-light" href="reza_additem.php">MyCar</a>
                </div>
            </div>
        </div>
    </nav>
    <br><br>
		...
		<form action="create.php" method="POST">
			...
			<div class="mb-3">
				...
				<input type="text" class="form-control" name="pemilik_mobil" value="reza" readonly>
			</div>
            <div class="mb-3">
